...
public class AverageDamagedTankState implements TankState {
    ...
    public AverageDamagedTankState(Tank tank, CollisionChecker collisionChecker, Level level, float movementSpeed, long lastShoot, Direction lastDirection) {
        this.tank = tank;
    ...
    public float processMovementProgress(float deltaTime) {
        tankMovementProgress = continueProgress(tankMovementProgress, deltaTime, movementSpeed * 2);
